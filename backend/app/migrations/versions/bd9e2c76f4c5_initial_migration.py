...
def upgrade() -> None:
    ...
    sa.Column('user_type', sa.Enum('JOB_SEEKER', 'EMPLOYER', 'ADMIN', name='usertype'), nullable=False),
    ...
    sa.Column('payment_type', sa.Enum('JOB_POSTING', 'FEATURED_JOB', 'SUBSCRIPTION', 'OTHER', name='payment_type_enum'), nullable=False),
    sa.Column('payment_method', sa.Enum('CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'PAYPAL', 'OTHER', name='payment_method_enum'), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'COMPLETED', 'FAILED', 'REFUNDED', 'CANCELLED', name='payment_status_enum'), nullable=True),
